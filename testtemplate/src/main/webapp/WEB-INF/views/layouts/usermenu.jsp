		...
		<div class="container">
			<nav
				...
				<a href="index.html" class="navbar-brand"> <img
					class="img-fluid" src="TeaHouse/img/logo.png" alt="Logo">
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<div class="navbar-nav ms-auto">
						<a href="home.do" class="nav-item nav-link active">Home</a> <a
							href="about.do" class="nav-item nav-link">About</a> <a
							href="product.do" class="nav-item nav-link">Products</a> <a
							href="store.do" class="nav-item nav-link">Store</a>
